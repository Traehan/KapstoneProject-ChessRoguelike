...
namespace Card
{
    ...
    public class ExplodeBleedFinisherEffectSO : SpellEffectSO
    {
        ...
        int _bleedUsed;
        int _spreadBleed;
        List<StatusController.StatusEntry> _targetStatusBeforeDamage;
        ...
        public override bool Resolve(SpellContext context)
        {
            ...
            _bleedUsed = 0;
            _spreadBleed = 0;
            _targetStatusBeforeDamage = null;
            ...
            // Snapshot status (incl. Fortify) before damage, since Fortify absorption is
            // stateful and must be restored on Undo, not just HP.
            _targetStatusBeforeDamage = _targetStatus.CaptureSnapshot();

            var hit = PieceDamage.Apply(_target, _bleedUsed, null, bypassFortify: false);
        ...
        public override void Undo(SpellContext context)
        {
            ...
            if (_targetStatusBeforeDamage != null && _targetStatus != null)
                _targetStatus.RestoreSnapshot(_targetStatusBeforeDamage);
