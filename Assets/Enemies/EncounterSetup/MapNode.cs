...
public class MapNode
{
    ...
    // Gauntlet (Elite/Trial) risk-reward flags. Only meaningful when nodeType == Encounter.
    public bool isGauntlet;
    public GauntletRewardType gauntletReward;
    public GauntletChallengeType gauntletChallenge;
    ...
    public MapNode(int row, int column, MapNodeType nodeType)
    {
        ...
        isGauntlet = false;
        gauntletReward = GauntletRewardType.Gold;
        gauntletChallenge = GauntletChallengeType.StatBoost;
    }
